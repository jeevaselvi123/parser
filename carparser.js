...
var grammar = {
    ...
    {"name": "expression$ebnf$1", "symbols": ["expression$ebnf$1", /[a-zA-Z]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "expression", "symbols": ["expression$ebnf$1"]},
    {"name": "expression", "symbols": ["input"]},
    {"name": "expression", "symbols": ["boolean"]},
    {"name": "expression", "symbols": ["myNull"]},
    ...
    {"name": "input$ebnf$1", "symbols": [/[0-9]/]},
    {"name": "input$ebnf$1", "symbols": ["input$ebnf$1", /[0-9]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
